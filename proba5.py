...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(610, 0, 131, 31))
        self.lineEdit.setObjectName("lineEdit")
        self.pushButton_4 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_4.setGeometry(QtCore.QRect(610, 40, 131, 41))
...
class Map_window(QMainWindow, Ui_MainWindow):
    ...
    def find_func(self):
        ...
        self.map = new_request(self.x, self.y, self.delta_x, self.delta_y, self.layer, ','.join(coords))
        self.label_2.setPixmap(QPixmap(self.map))
